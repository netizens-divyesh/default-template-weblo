...
const dummyData: Item[] = [
  { id: '1', name: 'John Doe', email: 'john@example.com', amount: 350.50, status: 'paid', paidBy: 'visa', avatar: 'https://avatar.iran.liara.run/public/1', avatarFallback: 'JD' },
  { id: '2', name: 'Jane Smith', email: 'jane@example.com', amount: 1200.00, status: 'processing', paidBy: 'mastercard', avatar: 'https://avatar.iran.liara.run/public/64', avatarFallback: 'JS' },
  { id: '3', name: 'Robert Brown', email: 'robert@example.com', amount: 85.00, status: 'pending', paidBy: 'visa', avatar: 'https://avatar.iran.liara.run/public/12', avatarFallback: 'RB' },
  { id: '4', name: 'Emily Davis', email: 'emily@example.com', amount: 450.00, status: 'failed', paidBy: 'mastercard', avatar: 'https://avatar.iran.liara.run/public/55', avatarFallback: 'ED' },
  { id: '5', name: 'Michael Wilson', email: 'michael@example.com', amount: 99.99, status: 'paid', paidBy: 'visa', avatar: 'https://avatar.iran.liara.run/public/22', avatarFallback: 'MW' },
]

const TransactionDatatable = ({ data = dummyData }: { data?: Item[] }) => {
  const pageSize = 5
